...
## Запуск
Для запуска приложения склонируйте репозиторий, в директории репозитория выполните команду **cp .env.example .env**, отредактируйте файл .env под свое окружение,
