...
//        .build();
//
//    when(walletRepository.findWithLockingById(testWalletId))
...
//
//    verify(walletRepository, times(2)).findWithLockingById(testWalletId);
...
//
//    verify(walletRepository, times(3)).findWithLockingById(testWalletId);
